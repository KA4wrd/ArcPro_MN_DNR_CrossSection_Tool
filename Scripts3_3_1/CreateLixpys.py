...
#%% 19 Join stratigraphy fields to 2d polyline feature classes
...
polygon_file = os.path.join(workspace, 'lixpy_2d_poly')
...
polygonfile_copy = arcpy.management.DeleteField(polygon_file, ['strat_oid','x_coord','y_coord', 'distance','pct_dist', 'z_top', 'z_bot',
                                                        'c5st_seq_no','relateid_1','county_c', 'xsec_id_1','elevation','thickness','BUFF_DIST','xsec_desc','dem','ORIG_FID','ORIG_FID_1'])[0]

# # make copy of unprojected strat poly file
printit("Copying lixpys_2d_poly.")
polygon_file_copy1 = os.path.join(workspace, "lixpy_2d_poly_prj")
